...
from Channel_new import UnreliableChannel
from TCP_Protocol_WithCongestionControl_AIMD import rdt_Sender, rdt_Receiver
import CWind
...
channel_for_data  = UnreliableChannel(env=env,name="DATA_CHANNEL",Pc=0,Pl=0.02,propagation_delay=2, transmission_rate=1000, bandwidth = 150)
...
# CWind.Time = CWind.Time[80:]
# CWind.Cwind = CWind.Cwind[80:]
